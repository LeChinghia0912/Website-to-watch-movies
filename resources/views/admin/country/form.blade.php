                ...
                <div class="card-body">
                    ...
                    @else
                        ...
                        <form action="{{ route('country.update', $country->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                <label for="title">Tiêu đề</label>
                                <input value="{{ $country->title }}" type="text" name="title" class="form-control" placeholder="Nhập vào dữ liệu..." id="title">
                                <label for="description">Mô tả</label>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <!-- Nút Xóa -->
                    <form id="delete-form-{{ $cate->id }}" action="{{ route('country.destroy', $cate) }}" method="POST">
                        @csrf
                        @method('DELETE')
